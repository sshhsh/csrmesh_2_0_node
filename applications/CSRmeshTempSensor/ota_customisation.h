...
#define IS_PAIRED           g_tsapp_data.gatt_data.paired
#define CONN_CENTRAL_ADDR   g_tsapp_data.gatt_data.con_bd_addr
#define DEVICE_RANDOM_ADDR  g_tsapp_data.random_bd_addr
