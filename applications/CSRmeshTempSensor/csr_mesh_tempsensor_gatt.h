 ...
 *
 *  FILE
 *      csr_mesh_tempsensor_gatt.h
 *
 *  DESCRIPTION
 *      Header file for CSRmesh Temperature Sensor GATT-related routines
 *
 ******************************************************************************/

#ifndef __CSR_MESH_TEMPSENSOR_GATT_H__
#define __CSR_MESH_TEMPSENSOR_GATT_H__
...
#endif /* __CSR_MESH_TEMPSENSOR_GATT_H__ */
