...
#ifndef __CSR_MESH_HEATER_H__
#define __CSR_MESH_HEATER_H__
...
} CSRMESH_HEATER_APP_DATA_T;

/* CSR mesh test application specific data */
extern CSRMESH_HEATER_APP_DATA_T g_heater_app_data;
