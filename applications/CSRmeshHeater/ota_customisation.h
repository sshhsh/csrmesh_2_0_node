 ...
 */
#define CONNECTION_CID      g_heater_app_data.gatt_data.st_ucid
#define IS_PAIRED           g_heater_app_data.gatt_data.paired
#define CONN_CENTRAL_ADDR   g_heater_app_data.gatt_data.con_bd_addr
#define DEVICE_RANDOM_ADDR  g_heater_app_data.random_bd_addr
